  ...
  HTML5Backend.prototype.setup = function setup() {
    ...
    if ('function' !== typeof DataTransfer.prototype.setDragImage) {
      DataTransfer.prototype.setDragImage = function (image, offsetX, offsetY, parentEl) {
        var randomDraggingClassName, dragStylesCSS, dragStylesEl, headEl;
        ...
        dragStylesCSS = ['.' + randomDraggingClassName, '{', 'background: url("' + image.src + '") no-repeat #fff 0 0 !important;', 'width: ' + image.width + 'px !important;', 'height: ' + image.height + 'px !important;', 'text-indent: -9999px !important;', 'border: 0 !important;', 'outline: 0 !important;', 'display: block !important;', '}', '.' + randomDraggingClassName + ' * {', 'display: none !important;', '}'];
